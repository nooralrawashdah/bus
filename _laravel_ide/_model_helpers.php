...
namespace App\Models {
     ...
     * @property string $Driver_license_num
     * @property string $Driver_Phone
     * @property string $Driver_Name
     * @property int $id
     * @property-read \App\Models\Bus $bus
     * @method static \Illuminate\Database\Eloquent\Builder<Drivers>|Drivers whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Drivers>|Drivers whereDriverName($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Drivers>|Drivers whereDriverPhone($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Drivers>|Drivers whereDriverLicenseNum($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Drivers>|Drivers whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Drivers>|Drivers whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Drivers>|Drivers newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Drivers>|Drivers newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Drivers>|Drivers query()
     ...
     */
    class Drivers extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property mixed $bus_id
     * @property mixed $Seat_number
     * @property int $id
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Bus> $buses
     * @property-read int|null $buses_count
     * @method static \Illuminate\Database\Eloquent\Builder<Seates>|Seates whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Seates>|Seates whereSeatNumber($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Seates>|Seates whereBusId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Seates>|Seates whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Seates>|Seates whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Seates>|Seates newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Seates>|Seates newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Seates>|Seates query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class Seates extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
